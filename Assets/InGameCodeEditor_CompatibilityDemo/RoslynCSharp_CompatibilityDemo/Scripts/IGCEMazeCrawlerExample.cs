...
namespace RoslynCSharp.Example
{
    ...
    /// </summary>
    public class IGCEMazeCrawlerExample : MonoBehaviour
    {
        // Private
        ...
        /// </summary>
        public CodeEditor runCrawlerEditor;
        /// <summary>
        /// The run code button.
        /// </summary>
        ...
        public void Awake()
        {
            ...
            codeEditorLoadTemplateButton.onClick.AddListener(() => runCrawlerEditor.Text = mazeCodeTemplate.text);
            codeEditorLoadSolutionButton.onClick.AddListener(() => runCrawlerEditor.Text = mazeCodeSolution.text);
        }
        ...
        public void Start()
        {
            ...
            if (showCompletedCodeOnStartup == true)
            {
                ...
                runCrawlerEditor.Text = mazeCodeSolution.text;
            }
            else
            {
                // Load the template code
                runCrawlerEditor.Text = mazeCodeTemplate.text;
            }
        }
        ...
        public void RunCrawler()
        {
            ...
            string cSharpSource = runCrawlerEditor.Text;
