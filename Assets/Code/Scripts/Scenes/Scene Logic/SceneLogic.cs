    ...
    public class SceneLogic : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (var lessonClass in lessonClasses)
            {
                ...
                newTab.GetComponent<Button>().onClick.AddListener(() => OnTabClick(lessonClasses.IndexOf(lessonClass)));
            }
            ...
            foreach (var lessonObjective in lessonObjectives)
            {
                ...
                if (lessonObjectives.IndexOf(lessonObjective) == 0) continue;
        ...
        {
            lessonObjectives[0].isCompleted = true;
            ...
            if (lessonObjectives.Count == id) OnCompleteLesson();
        }
        ...
        {
            if (lessonClasses[_currentTab].interactable)
            {
                // Save the changed source of the current tab before changing classes.
                lessonClasses[_currentTab].classSource = _codeEditorInputField.text;
            }
